...
<a href="https://up6.cc/2024/07/171978546266843.jpg" style="width:90px;margin:2px; border-radius: 0px 10px 0px 10px;" class="fl  fa   fa-star
 btn btn-success"> السوابر </a>
<a href="https://up6.cc/2024/07/171987615645661.gif" style="width:90px;margin:2px; border-radius: 0px 10px 0px 10px;" class="fl  fa fa-graduation-cap
...
div#l2 button,div#l3 button{margin-left: 3px;border:1px solid #ccc!important;border-radius:0px 10px 0px 10px!important;height:27px!important;padding:0 5px;}
...
div#l2 input#pass1,div#l2 input#u2,div#l3 input#pass2,div#l3 input#u3{border-radius:0px 5px 5px 5px!important;
box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 2px rgb(0 0 0), 0 0 0 0px #000;height: 23px!important;width:49%!important;padding:0!important;float:right;margin:2px 5px 2px 0}
div#l2 input#u2,div#l3 input#u3{margin-left:-6px;border:1px solid #e1e0e0;text-align:center}
...
div#l1,div#l2,div#l3{border-bottom:2px solid;margin-bottom:2px;border-top:2px solid;margin-top:2px;border-color:#bababa;border-radius:0px 10px 0px 10px!important;box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 1px rgb(0 0 0), 0 0 0 0px #000;height:height:69px}
